...
const DEFAULT_EVENTS = [
    ...
    subtitle: "Ride-Bhai Platform",
    description: "Expanded services to 200+ cities worldwide, serving millions of riders and thousands of drivers.",
  },
  {
    year: "2024",
    title: "10M Rides Completed",
    subtitle: "Ride-Bhai Platform",
    description: "Successfully completed 10 million rides with 99.9% uptime, maintaining high service quality.",
  },
  {
    year: "2023",
    title: "Safety Features Launch",
    subtitle: "Ride-Bhai Safety Initiative",
    description: "Introduced SOS emergency button, live location sharing, and driver background verification for enhanced safety.",
  },
  {
    year: "2022",
    title: "Driver Dashboard & Analytics",
    subtitle: "Ride-Bhai Driver Tools",
    description: "Released comprehensive driver dashboard for earnings tracking, GPS navigation, and trip management.",
  },
  {
    year: "2021",
    title: "Platform Launch",
    subtitle: "Ride-Bhai Official",
    description: "Ride-Bhai officially launched in initial cities with rider app, driver app, and basic admin tools.",
  },
  {
    year: "2020",
    title: "Beta Testing & Feedback",
    subtitle: "Ride-Bhai Beta",
    description: "Conducted beta testing in select cities, gathering valuable feedback from riders and drivers to improve the platform.",
  },
  {
    year: "2019",
    title: "Company Founded",
    subtitle: "Ride-Bhai Startup",
    description: "Ride-Bhai was founded with the mission to provide safe, reliable, and affordable transportation solutions.",
  },
];
export const ScrollTimeline = ({ events = DEFAULT_EVENTS, title = "Our Journey", subtitle = "Key milestones that have shaped RideBook into the platform it is today.", animationOrder = "sequential", cardAlignment = "alternating", lineColor = "bg-primary/30", activeColor = "bg-primary", progressIndicator = true, cardVariant = "default", cardEffect = "none", parallaxIntensity = 0.2, progressLineWidth = 2, progressLineCap = "round", dateFormat = "badge", revealAnimation = "fade", className = "", connectorStyle = "line", perspective = false, darkMode = false, smoothScroll = true, }) => {
